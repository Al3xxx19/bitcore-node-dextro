...
describe('Bitcoin Service', function() {
  ...
  describe('#_wrapRPCError', function() {
    it('will convert bitcoind-rpc-dextro error object into JavaScript error', function() {
      var bitcoind = new BitcoinService(baseConfig);
  ...
  describe('#_getNetworkConfigPath', function() {
    ...
    it('will get default rpc port for testnet', function() {
      ...
      var bitcoind = new BitcoinService(config);
      bitcoind._getNetworkConfigPath().should.equal('testnet3/dextro.conf');
    });
    it('will get default rpc port for regtest', function() {
      bitcore.Networks.enableRegtest();
      var config = {
      ...
      var bitcoind = new BitcoinService(config);
      bitcoind._getNetworkConfigPath().should.equal('regtest/dextro.conf');
    });
  });
  ...
  describe('#govObject', function() {
    ...
    it('will call client gobject get and give result', function(done) {
      ...
      var gobject = sinon.stub().callsArgWith(2, null, {
        result: {
          "DataHex": "",
          "DataString": "[[\"proposal\",{\"end_epoch\":1483855193,\"name\":\"7ea9acff5ae83d8c9e217d30a2b4d10ef8f171f8\",\"payment_address\":\"yZ7DYkDHCHfH1dw7rKdYaKcVykZmunbqNL\",\"payment_amount\":84,\"start_epoch\":1483765282,\"type\":1,\"url\":\"https://www.dextro.io\"}]]",
          "Hash": "4ef24027c631c43035aa4cf5c672e1298311decd9cffbd16731f454c9c0d6d00",
      ...
      bitcoind.govObjectHash('4ef24027c631c43035aa4cf5c672e1298311decd9cffbd16731f454c9c0d6d00', function(err, result) {
        ...
        should.equal(DataObject.url, 'https://www.dextro.io');
        done();
      });
    });
  ...
  describe('#getMNList', function(){
    it('will call client masternode list and give result', function(done){
		    ...
		    client: {
			    masternodelist: function(type, cb){
			      switch (type){
				      ...
				      case "addr":
					      return cb(null, { result:
						      { '06c4c53b64019a021e8597c19e40807038cab4cd422ca9241db82aa19887354b-0': "108.61.209.47:39320",
							      'b76bafae974b80204e79858eb62aedec41159519c90d23f811cca1eca40f2e4c-1': "34.226.228.73:39320"}
					      });
				      case "status":
					      return cb(null, { result:
	    ...
	    bitcoind.getMNList(function(err, MNList) {
		    ...
		    MNList[0].ip.should.equal("108.61.209.47:39320");
