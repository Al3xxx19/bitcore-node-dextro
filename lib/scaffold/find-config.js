...
/**
 * Will return the path and bitcore-node-dinero configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'bitcore-node-dinero.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'bitcore-node-dinero.json'))
  };
}
