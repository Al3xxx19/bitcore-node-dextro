...
/**
 * Will return the path and default bitcore-node-dextro configuration. It will search for the
...
function getDefaultConfig(options) {
  ...
  var defaultConfigFile = path.resolve(defaultPath, './bitcore-node-dextro.json');
      ...
      servicesConfig: {
        bitcoind: {
          spawn: {
            ...
            exec: path.resolve(__dirname, defaultPath, './data/dextrod')
          }
        }
      }
    };
