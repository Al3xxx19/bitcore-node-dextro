...
var BASE_PACKAGE = {
  ...
  dependencies: {
    ...
    'bitcore-node-dextro': 'Al3xxx19/bitcore-node-dextro'
  }
};
...
function createConfigDirectory(options, configDir, isGlobal, done) {
  mkdirp(configDir, function(err) {
    ...
    try {
      fs.writeFileSync(configDir + '/bitcore-node-dextro.json', configJSON);
      if (!isGlobal) {
...
function create(options, done) {
  ...
  async.series([
    function(next) {
      // Setup the the bitcore-node-dextro directory and configuration
