...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `bitcore-node-dinero create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ bitcore-node-dinero add wallet-service');
      console.log('    $ bitcore-node-dinero add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ bitcore-node-dinero remove wallet-service');
      console.log('    $ bitcore-node-dinero remove insight-api');
      console.log();
    });
